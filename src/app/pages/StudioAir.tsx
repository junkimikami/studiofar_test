...
import mainImg from "../../imports/Studio2ndFloor-1/e8015c1679873707f8eb2b24670b95324ebeff2a.png";
import floorMapImg from "../../imports/Studio2ndFloor-1/150d2622828e6a2162134aca77e9a327f50ad3e8.png";
import thumb1 from "../../imports/Studio2ndFloor-1/61c29ed43cad68d67bbffd8c44143714045732d8.png";
import thumb2 from "../../imports/Studio2ndFloor-1/b7593254f0d7ca003c5e1b67098a01b6ff576c8e.png";
import thumb3 from "../../imports/Studio2ndFloor-1/1966be5f8611e151b71f33598f184f275a808294.png";
import thumb4 from "../../imports/Studio2ndFloor-1/bf0047675c4396cf2ad494b13132747b677bbe8d.png";
import nextFloorImg1 from "../../imports/Studio2ndFloor-1/bf0047675c4396cf2ad494b13132747b677bbe8d.png";
import nextFloorImg2 from "../../imports/Studio2ndFloor-1/1966be5f8611e151b71f33598f184f275a808294.png";
      ...
      <section className="py-24 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-center mb-10">
            <svg viewBox="0 0 260 120" style={{ width: "100%", maxWidth: "260px", height: "auto" }} xmlns="http://www.w3.org/2000/svg">
              <text x="130" y="17" textAnchor="middle" fontFamily="Montserrat, sans-serif" fontSize="9" letterSpacing="3" fill="#4F6A7B">floor</text>
              <rect x="114" y="25" width="32" height="32" fill="none" stroke="#4F6A7B" strokeWidth="0.8"/>
              <text x="130" y="49" textAnchor="middle" fontFamily="Montserrat, sans-serif" fontSize="17" fill="#4F6A7B">2</text>
              <text x="130" y="108" textAnchor="middle" fontFamily="Montserrat, sans-serif" fontSize="38" letterSpacing="16" fill="#4F6A7B">AIR</text>
            </svg>
          </div>
