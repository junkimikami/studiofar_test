...
import mainImg from "../../imports/Studio1stFloor-1/e8015c1679873707f8eb2b24670b95324ebeff2a.png";
import floorMapImg from "../../imports/Studio1stFloor-1/150d2622828e6a2162134aca77e9a327f50ad3e8.png";
import thumb1 from "../../imports/Studio1stFloor-1/61c29ed43cad68d67bbffd8c44143714045732d8.png";
import thumb2 from "../../imports/Studio1stFloor-1/b7593254f0d7ca003c5e1b67098a01b6ff576c8e.png";
import thumb3 from "../../imports/Studio1stFloor-1/1966be5f8611e151b71f33598f184f275a808294.png";
import thumb4 from "../../imports/Studio1stFloor-1/bf0047675c4396cf2ad494b13132747b677bbe8d.png";
import nextFloorImg1 from "../../imports/Studio1stFloor-1/bf0047675c4396cf2ad494b13132747b677bbe8d.png";
import nextFloorImg2 from "../../imports/Studio1stFloor-1/1966be5f8611e151b71f33598f184f275a808294.png";
      ...
      <section className="py-24 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-center mb-10">
            <svg viewBox="0 0 520 120" style={{ width: "100%", maxWidth: "520px", height: "auto" }} xmlns="http://www.w3.org/2000/svg">
              <text x="260" y="17" textAnchor="middle" fontFamily="Montserrat, sans-serif" fontSize="9" letterSpacing="3" fill="#4F6A7B">floor</text>
              <rect x="244" y="25" width="32" height="32" fill="none" stroke="#4F6A7B" strokeWidth="0.8"/>
              <text x="260" y="49" textAnchor="middle" fontFamily="Montserrat, sans-serif" fontSize="17" fill="#4F6A7B">1</text>
              <text x="260" y="108" textAnchor="middle" fontFamily="Montserrat, sans-serif" fontSize="38" letterSpacing="11" fill="#4F6A7B">RADIANCE</text>
            </svg>
          </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2">
        ...
        <Link to="/studio/future" className="relative overflow-hidden group" style={{ height: "400px" }}>
          ...
          <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-colors flex flex-col items-center justify-center text-white">
            ...
            <h3 className="font-['Montserrat'] tracking-[10px]" style={{ fontSize: "28px" }}>FUTURE</h3>
            <p className="tracking-[2px] mt-4 opacity-0 group-hover:opacity-100 transition-opacity" style={{ fontSize: "14px" }}>
